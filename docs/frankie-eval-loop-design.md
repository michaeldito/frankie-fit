...
- scripted extraction benchmarks for `cardio-happy-path`, `lifting-mixed-path`, and `difficult-mixed-path`; the current suite covers 63 isolated user updates and passed 63/63 after the latest orchestration tuning
